...
class SchemaProcessingPipeline:
    ...
    def _extract_input_properties(self, raw_schema: Dict[str, Any]) -> Dict[str, Any]:
        """
        Traverses OpenAPI structure to find the actual input parameters.
        Adapted from legacy CatalogService logic.
        """
        if not raw_schema: 
            return {}
