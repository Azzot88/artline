            ...
            <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-4">
                <div>
                    <CardTitle className="text-xl font-bold flex items-center gap-2">
                        ...
                        {role ? "Edit Specialist" : "New Specialist"}
                    </CardTitle>
                    <CardDescription>
                        Configure the generation style and camera settings for this role.
                    </CardDescription>
                </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div className="space-y-4">
                        <div className="space-y-2">
                            ...
                            <Input id="name" placeholder="e.g. Cinematic Director" defaultValue={role?.name} />
                        </div>
                    ...
                    <div className="space-y-4">
                        <div className="bg-muted/50 rounded-lg p-4 border border-dashed border-muted-foreground/20 h-full flex flex-col items-center justify-center text-center text-muted-foreground">
                            ...
                            <p className="text-sm">Style Configuration & Camera Settings</p>
                            <p className="text-xs opacity-70 mt-1">(Coming Soon)</p>
                        </div>
                    </div>
                </div>
            </CardContent>
